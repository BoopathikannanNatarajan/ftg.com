...
<html lang="en">
  ...
  <div id="preloader-active">
    ...
    <main class="main">
    <section class="section banner-2 d-flex align-items-center" style="min-height: 80vh; position: relative; padding-bottom: 0; background: linear-gradient(90deg, rgb(234, 242, 249), white, white);">
  <div class="container">
    <div class="banner">
      <div class="row align-items-center py-5">
        <div class="col-lg-7 col-12 py-5">
          ...
          <h1 class="color-brand-1 mb-3 text-anim">Fintech Development</h1>
          <div class="row">
            <div class="col-lg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
          ...
          <div class="box-button mb-4 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
            <div class="text-center text-sm-start py-5">
              <a href="home.php">
        ...
        <div class="col-lg-5 col-12 text-center img-reveal">
          <img src="assets/imgs/ftg-pages/fintechhero.jpg" class="img-fluid" alt="Fintech Hero">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center" style="position: relative; margin-bottom: 70px; z-index:1;">
        <h2 style="font-weight:800; font-size:2.8rem; margin-bottom:20px; line-height:1.2; background: #00674f; -webkit-background-clip: text; color:transparent;">Why Fintech Development is Important for Your Company</h2>
