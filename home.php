...
<html lang="en">
  ...
  <div class="swiper-container swiper-hero-banner">
    <div class="swiper-wrapper">
      <div class="swiper-slide" style="position: relative;">
        <div style="background-image: url('assets/imgs/ftg-pages/hero.jpg'); background-size: cover; background-position: center; height: 600px;">
          <div style="background: rgba(0, 0, 0, 0.5); width: 100%; height: 100%; position: absolute; top: 0; left: 0;"></div>
          <div class="text-center text-white d-flex align-items-center justify-content-center" style="position: relative; height: 100%;">
            <div>
              <h1 class="mb-4 wow animate_animated animate_fadeInDown text-white fs-1" data-wow-delay=".2s">We unlock insights into innovation with  <br> End-to-End Integrated Solution!</h1>
              <p class="mb-4 font-lg wow animate_animated animate_fadeInUp" data-wow-delay=".4s"></p>
      ...
      <div class="swiper-slide" style="position: relative;">
        <div style="background-image: url('assets/imgs/ftg-pages/car.jpg'); background-size: cover; background-position: center; height: 600px;">
          <div style="background: rgba(0, 0, 0, 0.5); width: 100%; height: 100%; position: absolute; top: 0; left: 0;"></div>
          <div class="text-center text-white d-flex align-items-center justify-content-center" style="position: relative; height: 100%;">
            <div>
              <h1 class="mb-4 wow animate_animated animate_fadeInDown text-white fs-1" data-wow-delay=".2s">Together we make extraordinary  <br> impact & miracles</h1>
              <p class="mb-4 font-lg wow animate_animated animate_fadeInUp" data-wow-delay=".4s"></p>
              <div class="d-none d-sm-inline-block"><a href="home.php">
              <div class="col-12 text-center">
                   <button style="display:inline-block; padding:14px 25px; font-family:'Inter', sans-serif; font-weight:700; font-size:14px;  letter-spacing:1px; border:none; border-radius:50px; cursor:pointer; transition:all 0.3s ease; background:linear-gradient(135deg, #FF671F, #FFFFFF, #046A38); color:#024402; box-shadow:0 8px 24px rgba(4,106,56,0.25); position:relative; overflow:hidden;"
      ...
      <div class="swiper-slide" style="position: relative;">
        <div style="background-image: url('assets/imgs/ftg-pages/hero3.jpg'); background-size: cover; background-position: center; height: 600px;">
          <div style="background: rgba(0, 0, 0, 0.5); width: 100%; height: 100%; position: absolute; top: 0; left: 0;"></div>
          <div class="text-center text-white d-flex align-items-center justify-content-center" style="position: relative; height: 100%;">
            <div>
              <h1 class="mb-4 wow animate_animated animate_fadeInDown text-white fs-1" data-wow-delay=".2s">We transforms businesses through technology <br> and digital</h1>
              <p class="mb-4 font-lg wow animate_animated animate_fadeInUp" data-wow-delay=".4s"></p>
              <div class="d-none d-sm-inline-block"><a href="home.php">
              <div class="col-12 text-center">
                   <button style="display:inline-block; padding:14px 25px; font-family:'Inter', sans-serif; font-weight:700; font-size:14px;  letter-spacing:1px; border:none; border-radius:50px; cursor:pointer; transition:all 0.3s ease; background:linear-gradient(135deg, #FF671F, #FFFFFF, #046A38); color:#024402; box-shadow:0 8px 24px rgba(4,106,56,0.25); position:relative; overflow:hidden;"
  ...
  <div class="container">
    ...
    <div class="row mt-50 mb-100 align-items-center">
    <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="box-info-video">
                  <div class="img-reveal"><img class="bd-rd8 d-block" src="assets/imgs/ftg-pages/homeimg8.png" alt=""></div>
                </div>
              </div>
      ...
      <section class="section pt-0 pb-50 bg-7 mb-40 mt-100">
        <div class="container">
        ...
        <div class="container">
          ...
          <div class="row mt-50 mb-100">
            <div class="col-xl-3 col-lg-4">
              ...
              <div class="mt-80 text-start mb-40 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">  <div class="d-none d-sm-inline-block"><a href="home.php">
              <div class="col-12 text-center">
                   <button style="display:inline-block; padding:14px 25px; font-family:'Inter', sans-serif; font-weight:700; font-size:14px;  letter-spacing:1px; border:none; border-radius:50px; cursor:pointer; transition:all 0.3s ease; background:linear-gradient(135deg, #FF671F, #FFFFFF, #046A38); color:#024402; box-shadow:0 8px 24px rgba(4,106,56,0.25); position:relative; overflow:hidden;"
                    onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 12px 28px rgba(4,106,56,0.35)';"
                     onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 8px 24px rgba(4,106,56,0.25)';">
                    ...
                    </div></a></div><a class="btn btn-default font-sm-bold hover-up" href="#">Support Center
                  <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                  </svg></a></div>
            </div>
    ...
    <script>
  var swiperHero = new Swiper('.swiper-hero-banner', {
  loop: true,
  navigation: {
