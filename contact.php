...
<html lang="en">
  ...
  <div id="preloader-active">
    ...
    <main class="main">
    <section class="section mt-0" style="position: relative; padding-bottom: 0; background: linear-gradient(90deg, rgb(234, 242, 249), white, white);">
  <div class="container">
    <div class="banner">
      <div class="row align-items-center">
        <div class="col-lg-7 col-12 mb-4 mb-lg-0 py-3">
          <span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Get in Touch</span>
          <h1 class="color-brand-1 mb-3 mt-2 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
            We'd love to hear<br class="d-none d-lg-block">from you.
          </h1>
          <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
            Request a demo, ask a question, or get in touch here. If you're interested in working at Iori Corporation, check out our
            <a class="ml-1" href="career.html">careers page.</a>
          </p>
        </div>
        <div class="col-lg-5 col-12">
          <div class="box h-100">
            <div class="img-reveal h-100">
              <img src="assets/imgs/ftg-pages/contactbgg.jpg" alt="Contact" class="img-fluid w-100 object-fit-cover">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="container">
            ...
            <div class="row mt-50 mb-100">
              <div class="col-xl-3 col-lg-4">
                ...
                <div class="mt-80 text-start mb-40 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
