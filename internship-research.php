...
<html lang="en">
  ...
  <div id="preloader-active">
    ...
    <main class="main">
    <section class="section banner-3 pt-0">
  <div class="container">
    <div class="banner">
      <div class="row align-items-center py-2">
        <div class="col-lg-6 col-12">
          <span class="title-line line-48 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
            <span>Think. Digital. Grow.</span>
          </span>
          <h1 class="color-brand-1 mb-3 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
            Internship<br>& Research
          </h1>
          <p class="font-md color-grey-500 mb-4 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
            Collaborate, plan projects and manage resources with powerful features that your whole team
            <br class="d-none d-lg-block">can use. The latest news, tips and advice to help you run your business with less fuss.
          </p>

          <div class="box-button mb-4 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
        ...
        <div class="col-lg-6 col-12 position-relative text-center">
          <div class="wow animate__animated animate__fadeIn" data-wow-delay=".0s">
            <img class="image-banner-main d-block img-fluid w-75 mx-auto" src="assets/imgs/ftg-pages/intrenshipresearchbg.png" alt="Internship and Research">
          </div>
        </div>
...
<section class="section mt-100">
      ...
      <section class="section mt-50">
        <div class="container">
          ...
          <div class="row mt-50">
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".0s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/uiuximg.jpg" alt=""></div>
                <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".2s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/javaimg.jpg" alt=""></div>
                <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/systemengineerimg.jpg" alt=""></div>
                <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/dataengineerimg.jpg"  alt=""></div>
                <div class="card-info">
                  <h4 class="color-brand-1 mb-15">Data Engineer</h4>
                  <p class="font-md color-grey-500 mb-15">Builds pipelines and data warehouses, making sure your analytics tools are fed with clean, structured, real-time data.</p>
                
                </div>
              </div>
            </div><div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/securityengineerimg.jpg"  alt=""></div>
                <div class="card-info">
                  <h4 class="color-brand-1 mb-15">Security Engineer</h4>
                  <p class="font-md color-grey-500 mb-15">Protects your systems from threats, performs audits, and embeds cybersecurity best practices into every layer.</p>
                 
                </div>
              </div>
            </div><div class="col-lg-4 col-md-6 col-sm-6 wow animate_animated animate_fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/ftg-pages/qaimg.jpg"   alt=""></div>
                <div class="card-info">
                  <h4 class="color-brand-1 mb-15">QA Engineer</h4>
                  <p class="font-md color-grey-500 mb-15">Tests every release for bugs, speed, security, and usability—so your solution works flawlessly, every time.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center" style="position: relative; margin-bottom: 70px; z-index:1;">
        <h2 style="font-weight:800; font-size:2.8rem; margin-bottom:20px; line-height:1.2; background: #00674f; -webkit-background-clip: text; color:transparent;">Why Internship & Research is Important for Your Company</h2>
  ...
  <button style="display:inline-block; padding:16px 42px; font-family:'Inter', sans-serif; font-weight:700; font-size:1.1rem;  letter-spacing:1px; border:none; border-radius:50px; cursor:pointer; transition:all 0.3s ease; background:linear-gradient(135deg, #FF671F, #FFFFFF, #046A38); color:#024402; box-shadow:0 8px 24px rgba(4,106,56,0.25); position:relative; overflow:hidden;"
    onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 12px 28px rgba(4,106,56,0.35)';"
    onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 8px 24px rgba(4,106,56,0.25)';">
    Explore Our Internship&Research Solutions 
  </button>
</div>
    </div>
