      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-12 position-relative">
          <div class="box-image-main wow animate__animated animate__fadeIn" data-wow-delay=".0s">
            <img class="image-banner-main d-block img-fluid w-100" src="assets/imgs/ftg-pages/eduswbg.png" alt="">
          </div>
        </div>
      </div>
    </div>
...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-lg-10 text-center" style="position: relative; margin-bottom: 70px; z-index:1;">
      <h2 style="font-weight:800; font-size:2.8rem; margin-bottom:20px; line-height:1.2; background: #00674f; -webkit-background-clip: text; color:transparent;">Why Education Software is Important for Your Company</h2>
