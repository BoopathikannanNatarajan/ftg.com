        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-12 col-lg-6 ">
              <div class="box">
                <img class="img-main" src="assets/imgs/ftg-pages/healthcarebg.png" alt="">
              </div>
            </div>
            <div class="col-xl-6">
              <div class="box-banner-right-home6"><span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".s">Care. Responsibility. Support.</span>
                <h1 class="color-brand-1 mb-20 mt-5 wow animate__animated animate__fadeIn" data-wow-delay=".1s">Healthcare <br> Software</h1>
                <div class="row">
                  <div class="col-lg-10">
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10 text-center" style="position: relative; margin-bottom: 70px; z-index:1;">
        <h2 style="font-weight:800; font-size:2.8rem; margin-bottom:20px; line-height:1.2; background: #00674f; -webkit-background-clip: text; color:transparent;">Why Healthcare is Important for Your Company</h2>
